...
module.exports = {
  content: [
    ...
    './menus.html', './add-items.html','./mainmenu.html', './subscription.html', './qrcode.html', './links.html', './features.html', './menus-settings.html', './hours.html', './item-details.html', './item-details-additional.html'
  ],
  theme: {
    fontFamily: {
      'body': ['Montserrat'],
